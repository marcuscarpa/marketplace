...
export const pt: Messages = {
  ...
  home: {
    ...
    priorityShipping: 'Envio',
    priorityShippingBody: 'Receba seus produtos em 5 a 7 dias úteis.',
    ...
    easyReturns: 'Devoluções & Trocas',
    easyReturnsBody: '7 Dias | Reembolso Total\n30 Dias | Crédito na Loja\nAplicam-se Termos & Condições',

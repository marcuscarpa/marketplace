...
import { getShippingSectionsPt, getShippingStepsPt } from '@/lib/help/shipping-content.pt';
...
function getShippingSectionsEn(): HelpAccordionItem[] {
  return [
    {
...
export function getShippingSteps(locale: string) {
  return locale === 'pt' ? getShippingStepsPt() : getShippingStepsEn();
}

export function getShippingSections(locale: string) {
  return locale === 'pt' ? getShippingSectionsPt() : getShippingSectionsEn();
}

/** @deprecated Use getShippingSteps(locale) */
export const SHIPPING_STEPS = getShippingStepsEn();

/** @deprecated Use getShippingSections(locale) */
export const SHIPPING_SECTIONS = getShippingSectionsEn();
